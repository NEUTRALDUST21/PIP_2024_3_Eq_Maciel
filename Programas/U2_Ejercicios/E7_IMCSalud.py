...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def calcular(self):
        ...
        if imc < 18.5:
            ...
            self.lblIMC.setPixmap(QtGui.QPixmap(":/U2_IMC/IMC_Bajo.png"))
        elif 18.5 < imc < 24.9:
            ...
            self.lblIMC.setPixmap(QtGui.QPixmap(":/U2_IMC/IMC_Normal.png"))
        elif 25.0 < imc < 29.9:
            ...
            self.lblIMC.setPixmap(QtGui.QPixmap(":/U2_IMC/IMC_Sobrepeso.png"))
        elif 30 < imc:
            ...
            self.lblIMC.setPixmap(QtGui.QPixmap(":/U2_IMC/IMC_Obesidad.png"))
