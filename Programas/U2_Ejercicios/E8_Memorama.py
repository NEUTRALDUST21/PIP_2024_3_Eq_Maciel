...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def mostrarCarta(self):
        ...
        match name:
            ...
            case "opc11": index = 10
            case "opc12": index = 11
        obj.setStyleSheet("border-image: url(" + self.imagenes[self.randoImgs[index]] + "); background-color: rgb(255, 255, 255);")
        ...
        if self.opcA != -1 and self.opcB != -1:
            if self.opcA == self.opcB:
                ...
                self.senderA.setStyleSheet("border-image: url(:/U2_MMRM/desc.png); background-color: rgb(255, 255, 255);")
                self.senderA.setEnabled(True)
                self.senderB.setStyleSheet("border-image: url(:/U2_MMRM/desc.png); background-color: rgb(255, 255, 255);")
    ...
    def start(self):
        c = 0
        for i in self.btnList:
            i.setStyleSheet("border-image: url(:/U2_MMRM/desc.png); background-color: rgb(255, 255, 255);")
            i.setEnabled(True)
