...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def clickCasilla(self):
        ...
        if self.turno == 1:
            obj.setStyleSheet("font: 36pt \"Comic Sans MS\";""background-color: rgb(255, 255, 255);""color: rgb(0, 0, 255)")
            self.turno = 2
            self.lbTurno.setText("Jugador 2 (O)")
            self.lbTurno.setStyleSheet("font: 75 20pt \"Comic Sans MS\";""color: rgb(255, 0, 0);")
        else:
            self.turno = 1
            self.lbTurno.setText("Jugador 1 (X)")
            obj.setStyleSheet("font: 36pt \"Comic Sans MS\";""background-color: rgb(255, 255, 255);""color: rgb(255, 0, 0)")
            self.lbTurno.setStyleSheet("font: 75 20pt \"Comic Sans MS\";""color: rgb(0, 0, 255);")
        self.matches()
