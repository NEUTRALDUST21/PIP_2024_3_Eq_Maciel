...
qtCreatorFile = "P16_SliderNombres.ui" # Nombre del archivo aqui
...
class MyApp(QtWidgets. QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        # Area de los Signals
        self.lista_nombres = [ "Pedro", "Juan", "Paola", "Maria", "Jesus", "Marcy"]
        self.index_nombre = 0
    ...
    def iniciar(self):
        self.valor_nombre = 0
        # valor milisengundos (500) cambia cada medio segundo
